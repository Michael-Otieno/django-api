    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_number', models.CharField(default=None, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ProofOwnershipDocument', models.FileField(blank=True, db_column='image_url', null=True, upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LandOwner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shamba.landowner')),
            ],
        ),
    ]
